...
export default {
  ...
  // RBAC - Groups
  listGroups: `${api_host}/group/list`,
  createGroup: `${api_host}/group/create`,
  updateGroup: (groupId: string) => `${api_host}/group/${groupId}`,
  deleteGroup: (groupId: string) => `${api_host}/group/${groupId}`,
  listGroupMembers: (groupId: string) => `${api_host}/group/${groupId}/members`,
  addGroupMember: (groupId: string) => `${api_host}/group/${groupId}/member`,
  removeGroupMember: (groupId: string, userId: string) =>
    `${api_host}/group/${groupId}/member/${userId}`,

  // RBAC - Permissions
  setKbPermission: `${api_host}/permission/kb`,
  updateKbPermission: (permissionId: string) =>
    `${api_host}/permission/kb/${permissionId}`,
  deleteKbPermission: (permissionId: string) =>
    `${api_host}/permission/kb/${permissionId}`,
  getKbPermissions: (kbId: string) => `${api_host}/permission/kb/${kbId}`,
  getMyPermissions: `${api_host}/permission/my`,
};
