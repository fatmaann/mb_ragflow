...
from api.db.services.rbac_service import UserGroupMemberService
...
from api.db.services.rbac_service import UserGroupMemberService, UserGroupService
...
def user_register(user_id, user):
    ...
    # Add user to default "Users" group for RBAC
    UserGroupMemberService.add_user_to_default_group(user_id)
